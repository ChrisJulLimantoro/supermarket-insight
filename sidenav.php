...
<nav
  id="sidenav-8"
  class="absolute left-0 top-0 z-[1035] h-auto h-min-full w-60 -translate-x-full overflow-hidden bg-white shadow-[0_4px_12px_0_rgba(0,0,0,0.07),_0_2px_4px_rgba(0,0,0,0.05)] data-[te-sidenav-hidden='false']:translate-x-0 dark:bg-zinc-800"
  ...
  <a
    ...
    <span class="text-center font-bold">Supermarket<br>insight</span>
  </a>
  <ul
