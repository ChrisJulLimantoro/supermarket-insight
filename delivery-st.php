    ...
    <body>
        ...
        <div class="ml-60 px-8 py-3">
            <div class="flex w-full h-24 rounded-lg shadow-lg items-center justify-center mb-8">
                <h1 class="text-center uppercase font-bold text-3xl">Data Delivery To Store</h1>
            </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            $("#form-delivery").on("change",function(){
                ...
                formData.append("upload","delivery-to-store");
                $.ajax({
                    url : './upload.php',
                    type: "POST",
                    data: formData,
